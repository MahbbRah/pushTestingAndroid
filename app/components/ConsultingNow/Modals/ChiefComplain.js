...
export default class ChiefComplain extends React.Component {

    constructor(props){
        super(props);
        this.state = {
            selectedCheifComplain: '',
    ...
    deleteSelected = (key) => {
        ...
        let newItems = this.props.getComplains.filter( (v, k) => k !== key);
        this.props.setComplains('', newItems);
    }
    ...
    render(){
        ...
        let chiefComplains = this.props.getComplains.map( (item, key) => {
                ...
                <View style={{ flex: 1}}>
                    <View style={{
                        ...
                        <SearchAndReturnItem 
                            ...
                            getItems={this.props.getComplains}
                            setItems={this.props.setComplains}
                        ...
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View>
                                <Text style={{ color: "#FFF", fontSize: 17 }}>Chief Complain</Text>
