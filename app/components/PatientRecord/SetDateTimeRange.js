                        ...
                        <View style={{
                            ...
                            <View>
                                ...
                                <View style={{ borderBottomWidth: 1, borderBottomColor: '#ddd'}}>
                                    <Picker
                                        onValueChange={ ( fromTime) => this.setState({fromTime})}>
                                        {pickerItems}
                                    </Picker>
                                </View>
                            </View>
                            <View>
                                ...
                                <View style={{ borderBottomWidth: 1, borderBottomColor: '#ddd'}}>
                                    <Picker
                                        onValueChange={(toTime) => this.setState({toTime})}>
                                        {pickerItems}
                                    </Picker>
                                </View>
                            </View>
                                ...
                                <View style={{ marginRight: 20}}>
                                    <TouchableHighlight underlayColor="transparent" onPress={this.handleDatePicker}>
                                        <View style={{ flexDirection: "row", borderWidth: 1, borderColor: '#DDD', padding: 7 }}>
                                            <Ionicons name="md-time" size={23} style={{ color: '#00B9FC', marginRight: 5}}/>
                    ...
                    <View style={{
                        ...
                        <TouchableHighlight style={styles.addBtn}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
                                <Ionicons name="md-add" size={22} style={{ color: '#fff', marginRight: 10, marginLeft: 5}} />
